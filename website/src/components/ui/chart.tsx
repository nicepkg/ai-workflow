...
type TooltipPayload = Omit<RechartsTooltipPayload<ValueType, NameType>, "payload"> & {
...
type ChartTooltipProps = Omit<RechartsPrimitive.TooltipProps<ValueType, NameType>, "payload"> & {
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          .map((item, index) => {
            ...
            const itemConfig = getPayloadConfigFromPayload(config, item, key);
            const payloadFill =
              item.payload && typeof item.payload === "object" ? item.payload.fill : undefined;
