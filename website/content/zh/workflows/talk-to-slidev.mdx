...
description: 你的 AI 主题演讲团队，包含 18 个预配置技能
---

# Talk to Slidev 工作流

你的 AI 主题演讲团队，为创建精美的 Slidev 演示文稿提供 18 个预配置技能。
...
阶段 1：脚本生成
├── ppt-creator → 完整演讲稿，带演讲备注
└── presentation-builder → 详细演示大纲

阶段 2：Slidev 生成
├── 使用 Slidev markdown 语法编写 slides.md
