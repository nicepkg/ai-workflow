...
- **Compact conversations:**
  - Claude uses auto-compact by default when context reaches approximately 95% capacity. To trigger compaction earlier, set [`CLAUDE_AUTOCOMPACT_PCT_OVERRIDE`](/docs/en/settings#environment-variables) to a lower percentage (for example, `50`)
